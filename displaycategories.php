...
<body>
    ...
    <div id="wrapper">
                      ...
                      <!--  <div class="form-group col-md-4 m-t-n-15">
                            ...
                            <div class="col-md-1  m-t-n-15">
                                <button class="fcbtn btn btn-info btn-outline btn-1e  no-bod-rad">
                                   &nbsp;&nbsp;<a class="fa fa-plus" href="addcategories.php">Add Sub-Category</a> 
                                    <!--  -->
                                </button>
                            </div>
                                ...
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <label for="checkbox0">Checkbox</label>
                                            </div>
                                            </th>
                                            <th class="text-center">Sl.No</th>
                                            <th class="text-center">Sub-Categories Name</th>
                                            <th class="text-center">Sub-Category-IMG</th>
                                            <th class="text-center">Sub-Category-Priority</th>
                                            <th class="text-center">Sub-Category Status</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          <td><div class="checkbox m-t-0 m-b-0">
                                            ...
                                            <td class="text-center">
                                             <i class="fa fa-eye text-success"></i>   <i class="fa fa-edit text-primary"></i>     <i class="fa fa-trash text-danger"></i> 
        ...
        $res=select_query('subcat_tbl','subcat_id',12);
            if($res)
             {
                $i =1;
...
<tr>
    ...
    <td class="text-center"><span class="text-muted"> <?php echo ucfirst($row['subcat_name']) ?></span></td>
    <td class="text-center"><img src="img/<?php echo $row['subcat_img'];?>" width=50 height=50/></td>
    <td class="text-center"><?php echo $row['subcat_prio']?></td>
     <td class="text-center"> 
    <i >
    ...
    <td class="text-center"> 
    <i >
    <a class="fa fa-edit text-primary" href="updatesubcat.php?uid=<?php echo base64_encode($row['subcat_id']);?>">Update</a>
    </i>
    <i >
    <a class="fa fa-trash text-danger" href="deletesubcat.php?uid=<?php echo base64_encode($row['subcat_id']); ?>">Delete</a>
    </i>
    </td>
    </td>
</tr>
