...
<body>
    ...
    <div id="wrapper">
                      ...
                      <!--  <div class="form-group col-md-4 m-t-n-15">
                            ...
                            <div class="col-md-1  m-t-n-15">
                                <button class="fcbtn btn btn-info btn-outline btn-1e  no-bod-rad">
                                   &nbsp;&nbsp;<a class="fa fa-plus" href="addcategory.php">Add Category</a> 
                                    <!--  -->
                                </button>
                            </div>
                                    ...
                                    <thead>
                                        <tr>
                                           ...
                                           <th class="text-center">Sl.No</th>
                                            ...
                                            <th class="text-center">Category-IMG</th>
        ...
        $res=select_query('category_tbl','cat_id',10);
            if($res)
             {
                $i =1;
...
<tr>
    ...
    <td><span class="text-muted"> <?php echo ucfirst($row['cat_name']) ?></span></td>
    <td class="text-center"><img src="upload/<?php echo $row['cat_img']; ?>" width=70 height=50/></td>
    <td class="text-center"><?php echo ucfirst($row['cat_priority']) ?></td>
    ...
    <i ></i> 
    <i >
    <a class="fa fa-edit text-primary" href="updatecat.php?uid=<?php echo base64_encode($row['cat_id']);?>">Update</a>
    </i>
    <i >
    <a class="fa fa-trash text-danger" href="deletecat.php?uid=<?php echo base64_encode($row['cat_id']); ?>">Delete</a>
    </i>
    </td>
    </td>
</tr>
